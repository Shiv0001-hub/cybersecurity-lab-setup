...
I've uploaded all the screenshots from my setup process into the `screenshots/` folder in this repository, which shows my exact terminal outputs and VirtualBox configurations.
