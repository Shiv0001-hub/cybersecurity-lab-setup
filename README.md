...
Welcome to my cybersecurity lab setup documentation! This repository covers the complete step-by-step setup of an isolated ethical hacking lab environment built on my host machine as part of the NetworkWalks Academy Week 1 Project Module.
...
## 🎯 Lab Objectives & Network Topology
...
```
┌─────────────────────────────────────────────────────────┐
│        Host Machine (HP Victus - Fedora Linux 44)       │
│                 Shared Folder: ~/Downloads              │
└────────────────────────────┬────────────────────────────┘
                             │
              VirtualBox NAT Network (10.0.0.0/24)
              Gateway: 10.0.0.1 | DHCP: Enabled
                             │
            ┌────────────────┴────────────────┐
            │                                 │
     ┌──────▼────────┐               ┌────────▼───────┐
     │  Kali Linux   │               │ Windows/Target │
     │ (Attack VM)   │               │  (Future Labs) │
...
### Step 8: Taking a Clean VM Snapshot
Before doing any testing or making changes, I took a clean snapshot titled `Snapshot 1` (Base Clean Setup). This allows me to roll back in seconds if any future experiment breaks the environment.

![Taking VM Snapshot](Screenshots/Screenshot%20From%202026-09-09%2017-52-41.png)
*Figure 9: Clean state VirtualBox snapshot for easy recovery.*

---

### Step 9: Verification & Network Testing
I opened the Kali terminal to verify the network configuration:
...
4. `ping -c 4 8.8.8.8` — Confirmed active outbound internet access.

![Terminal Verification Tests](Screenshots/Screenshot_2026-09-09_07-42-44.png)
*Figure 10: Terminal output showing valid IP, default gateway route, and successful ping tests.*

---

### Step 10: Shared Folder Verification Inside Kali
Finally, I verified that the shared folder was mounted and accessible inside Kali's file manager and terminal, allowing bidirectional file exchange between Fedora and Kali.

![Shared Folder Working in Kali](Screenshots/Screenshot_2026-09-09_08-03-53.png)
*Figure 11: Accessing the shared folder and files from within Kali Linux.*
...
└── Screenshots/              # Visual proof and step-by-step screenshots
    ├── Screenshot From 2026-09-09 16-25-24.png   # 7zip installation
    ├── Screenshot From 2026-09-09 16-25-59.png   # Extracting Kali
    ├── Screenshot From 2026-09-09 16-36-28.png   # NAT Network creation
    ├── Screenshot From 2026-09-09 16-38-47.png   # Attaching VM to NATNetwork
    ├── Screenshot From 2026-09-09 16-39-52.png   # VM System Specs
    ├── Screenshot From 2026-09-09 17-41-25.png   # Shared Clipboard setup
    ├── Screenshot From 2026-09-09 17-42-01.png   # Static IP configuration
    ├── Screenshot From 2026-09-09 17-46-11.png   # Shared Folder setup
    ├── Screenshot From 2026-09-09 17-52-41.png   # Snapshot taken
    ├── Screenshot_2026-09-09_07-42-44.png        # Terminal verification
    └── Screenshot_2026-09-09_08-03-53.png        # Shared Folder verified
```
